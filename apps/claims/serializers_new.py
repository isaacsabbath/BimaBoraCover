# For beginners: This file (apps/claims/serializers_new.py) contains part of the application logic.
...
class ClaimSubmitSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        validated_data['documents'] = [
            {'filename': doc.name, 'size': doc.size}
